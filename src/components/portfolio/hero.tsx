		...
		<div data-testid="hero" className={cn("flex flex-col gap-6", className)}>
			...
			<div className="flex flex-wrap items-center gap-3 pt-2">
				<a
					...
					className="inline-flex items-center gap-2 rounded-md border border-accent bg-accent/10 px-4 py-2 text-sm text-accent transition hover:bg-accent/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
				>
				...
				<a
					...
					className="inline-flex items-center gap-2 rounded-md border border-border bg-bg/40 px-4 py-2 text-sm text-fg transition hover:border-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
				>
